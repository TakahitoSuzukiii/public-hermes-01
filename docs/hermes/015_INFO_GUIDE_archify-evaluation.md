...
- **記録日:** 2026-09-14
- **位置づけ:** GitHub週間トレンドで急伸していた`tt-a1i/archify`について、`docs/hermes/010`で評価・導入済みの`cathrynlavery/diagram-design`と同じ手順(信頼性チェック→実機での比較検証)で調査した記録。作図スキル選定の第2弾。Prime自身の作図能力・スキル運用ノウハウとして記録。
