...
- **記録日:** 2026-09-08
- **位置づけ:** 完成済みのExcelパラメータシートをもとに、Claude(チャット版)を使ってAWS CloudFormationテンプレートを自動生成するための、具体的な手順・注意点をまとめた実践ガイド。AIエージェント(Claude)を実務のIaC生成に活用する際のプロンプト設計・検証プロセスの一例として、Prime自身の運用ノウハウとも接続する内容。
